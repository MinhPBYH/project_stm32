 ...
 * Return value		: none
 */
static void LCD5110_DelayInit(LCD5110_Time* LCD5110)
{
	delay_init(LCD5110->Timer);
}
static void LCD5110_DelayUs(LCD5110_Time* LCD5110, uint16_t Time)
{
	delay_us(LCD5110->Timer, Time);
}
static void LCD5110_DelayMs(LCD5110_Time* LCD5110, uint16_t Time)
{
	delay_ms(LCD5110->Timer, Time);
}
